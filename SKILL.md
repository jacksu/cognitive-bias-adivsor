...
用户说"怎么说服""谈判技巧""怎么激励团队""怎么让孩子配合""日常沟通""怎么利用偏差"等时，按场景输出对应战术表。

### 1. 谈判与说服

| 偏差 | 怎么用 | 例子 |
|------|--------|------|
| **锚定效应** | 先出价/先提条件设定锚点 | 谈薪资时先报一个合理偏高的数，对方的还价会围绕它波动 |
| **禀赋效应** | 让人先"拥有"再谈放弃 | 试用期/免费试用的本质——用了之后就舍不得退了 |
| **损失厌恶** | 强调"不做的损失"比"做的好处"更有说服力 | "这个月不报，下月涨 30%"比"早鸟价 8 折"更有效 |
| **互惠原则** | 先给予再请求 | 请人帮忙前，先提供一个小的帮助或让步 |

### 2. 团队管理与激励

| 偏差 | 怎么用 | 例子 |
|------|--------|------|
| **确认偏误** | 先让对方说出判断，再给反馈 | 问"你觉得哪里最可行？"而非"你觉得行不行？" |
| **自利性偏误** | 公开表扬，私下批评 | 成功归团队，失败自己扛——保护对方的自我归因 |
| **激励偏差** | 奖励"行为"而非只奖励"结果" | 奖励主动汇报问题的人，而不是只奖励不出问题的人 |
| **承诺一致性** | 让人公开承诺一个小目标 | 晨会上说"我今天要完成 X"，完成率显著提高 |
| **社会证明** | 用已有认同推动跟进 | "部门已有 5 人用这个方案"比"我建议用"更有推动力 |

### 3. 教育与亲子

| 偏差 | 怎么用 | 例子 |
|------|--------|------|
| **成长心态** | 夸努力不夸聪明 | "你这次很认真"比"你真聪明"更能培养韧性 |
| **峰终定律** | 让每次互动以好体验结束 | 批评完之后给一个正向鼓励，孩子记住的是结尾 |
| **选择过载** | 给有限选项而非开放式命令 | "你想先做数学还是语文？"比"该写作业了"更有效 |
| **损失框架** | 珍惜已有比争取更多更直观 | "你已经积累的积分快过期了"比"快来赚积分"更有行动力 |

### 4. 日常沟通

| 偏差 | 怎么用 | 例子 |
|------|--------|------|
| **框架效应** | 同一件事换一种说法 | "成功率 80%"和"失败率 20%"同一件事，前者让人更愿意尝试 |
| **从众效应** | 善用社会证明 | "邻居都开始了"比"你应该做"温和但更有说服力 |
| **单纯曝光效应** | 多次温和曝光建立好感 | 想推动一个新想法？不要一次推销，在多次闲聊中不经意提到 |
| **峰终定律** | 约饭/见面以愉快结尾收场 | 最后聊个轻松话题再走，对方对整个见面的印象会更好 |

### 输出格式

用户询问具体场景时，先复述三条底线（简化为一行），再输出对应场景的战术表并附带 1-2 个具体话术示例。
