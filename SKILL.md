...
| 模式 | 询问题目 |
|------|----------|
| **完整十问** | Q1 → Q2 → Q3 → Q4 → Q5 → Q6 → Q7 → Q8 → Q9 → Q10 |
| **自适应 · 职业/学业** | Q1 → Q4 → Q6 → Q9 → Q10 |
| **自适应 · 投资/消费** | Q1 → Q5 → Q6 → Q8 → Q10 |
| **自适应 · 人际/情感** | Q2 → Q3 → Q7 |
| **自适应 · 个人/日常** | Q5 → Q6 → Q9 |
| **极速模式** | Q1 → Q6 → Q9 |
...
| "激励偏差为什么是偏差？" | 奖励机制会在不知不觉中改变判断——你会更相信"对自己有利"的事。芒格的核心洞察：利益关系扭曲判断，比你想的更普遍。 |
